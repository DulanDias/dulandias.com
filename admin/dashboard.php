<?php
   if(isset($_FILES['image'])){
      ...
      if(empty($errors)==true){
         move_uploaded_file($file_tmp,"live/images/".$file_name);
         echo "Success";
      }else{
         print_r($errors);
      }
...
<head>
        ...
        <meta name="description" content="This is the official website of Dulan Dias.">
        <meta name="keywords" content="resume, dulan, dias, dulan dias, sri lanka">
        <meta name="author" content="devtek">

        <title>Dashboard | Dulan Dias</title>
            ...
            <header id="masthead" class="header" role="banner">
                ...
                <div class="header-wrap">
                    ...
                    <div class="header-bottom">
                        ...
                        <!-- copy-text -->
                        <div class="copy-text">
                        	<p>&copy; 2016 <a href="http://www.devtek.tk">devtek</a></p>
                        </div>
                        <!-- copy-text -->
				...
				<!-- InstanceBeginEditable name="Page-Content" -->
                    ...
                    <!-- .layout-medium -->
                        <div class="layout-medium">
                            ...
                            <!-- page-title -->
                            <h1 class="page-title">
                                <i class="pe-7s-graph3"></i>dashboard
                            </h1>
                            <!-- page-title -->
